...
<%--													<li><a href="AdminLogin.jsp">Admin</a></li>--%>
				...
				<div class="container">
					...
					%>
										...
										<a href="mailto:niranjachand134@gmail.com">kccbank@gmail.com</a>
									</div>
								</div>
								<div class="col-md-4">
									<div class="mini-contact">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="mini-contact">
										<h2>Visit us</h2>
										<address>
											KCC Institute of Technology and Management <br>
											Kathmandu Nepal
										</address>
									</div>
								</div>
							...
							<div class="contact-us-form">
								...
								<form action="https://formsubmit.co/niranjachand134@gamil.com" method="post">
									<div class="row">
										<div class="col-md-6">
									...
									<div class="input-group text-area">
										...
										<textarea id="query" name="Message" class="form-control" rows="6" required="" placeholder="Query/Feedback"></textarea>
									</div>
